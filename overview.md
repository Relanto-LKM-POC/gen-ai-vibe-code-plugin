...
- **Flexible Configuration** - Environment variable support through `.env` file
- **Salesforce Integration** - Configurable Salesforce URLs and authentication
- **Work Hour Customization** - Customizable estimation calculations per organization
- **Multi-Environment Support** - Easy configuration for dev, staging, and production
